...
PROGRAM_VERSION="2.1.28"
PROGRAM_NAME="cyrus-sasl"
SHA512_SUM="db15af9079758a9f385457a79390c8a7cd7ea666573dace8bf4fb01bb4b49037538d67285727d6a70ad799d2e2318f265c9372e2427de9371d626a1959dd6f78"
...
SOFTWARES_DIR=$SOFTWARES_DIR $BASE_DIR/utils/download-file.sh \
  "https://github.com/cyrusimap/cyrus-sasl/releases/download/${PROGRAM_FULL}/${PROGRAM_FULL}.tar.gz" \
  "$PROGRAM_FULL.tar.gz" \
  "$SHA512_SUM"
cd $SOURCES_DIR
